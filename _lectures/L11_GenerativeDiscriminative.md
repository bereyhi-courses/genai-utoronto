...
tldr: "Formulation - Part 2"
stat: lec
# for lectures stat: lec
description: In this lecture we study the discriminative and generative models. We see that many earlier computational models we learned are indeed discriminative. We further learn how we could use a generative model for a discriminative learning task.
videoID: ilWOBFlLPjs    
