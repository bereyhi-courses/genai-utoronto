...
description: In this lecture we discuss VAEs with discrete latent, in particular the VQ-VAE. We see the idea behind quantizing the latent and its implementational framework. 
videoID: _ruOL_Cj1cU 
