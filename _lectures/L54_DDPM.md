...
description: In this lecture, we learn the well-known case of DPMs, i.e., Denoising DPM (DDPM). We see how we build the denoiser in these models and how we can train and sample from them. This describes the most conventional form of diffusion models used in practice. 
videoID: p1hcuQqWXUY 
