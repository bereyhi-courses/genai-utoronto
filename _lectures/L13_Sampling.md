---
type: lecture
date: 2025-05-27T18:20:00-4:00
title: "Lecture 13: Explicit Distribution Learning - Sampling"
tldr: "Explicit Methods - Part 1"
stat: lec
# for lectures stat: lec
description: In this lecture, we start with "explicit learning methods"; the term we use to refer to approaches that learn data distribution explicitly. We see that direct sampling from them is not easy and we need to develop an structured modeling.
videoID: hsDZ5vJlx-k      
