...
tldr: "Flow-based Models - Part II"
stat: lec
# for lectures stat: lec
description: We study the flow-based models which use normalizing flow to learn data distribution. We discuss their training and sampling and find out how complex they are.
videoID: vkT-HQ-9dL8 
